    ...
    async function(moduleArg = {}) {
      ...
      e.jsepInit = (a, b) => {
        if ("webgpu" === a) {
          ...
          e.webnnRegisterMLConstant = (d, f, g, h, l, m) => c.registerMLConstant(d, f, g, h, l, e.Eb,
            m);
      ...
      let ja = () => {
        ...
        (b => {
          for (const c of b) e[c] = a(e[c], () => e[c], d => e[c] = d)
      ...
      } else if (ea || k) k ? v = self.location.href : "undefined" != typeof document &&
        document.currentScript && (v = document.currentScript.src), _scriptName && (v = _scriptName), v.startsWith("blob:") ? v = "" : v = v.slice(0, v.replace(/[?#].*/, "").lastIndexOf("/") + 1), n || (k && (oa = a => {
      ...
      var ua = e.wasmBinary,
        z, va, A = !1,
        wa, B, xa, ya, za, Aa, Ba, Ca, C, Da, Ea, qa = a => a.startsWith("file://");
        ...
        function a(b) {
          try {
            ...
            if ("load" === d) {
              ...
              for (const g of c.Rb)
                if (!e[g] || e[g].proxy) e[g] = (...h) => {
                  postMessage({
                    Bb: "callHandler",
                    Qb: g,
                    args: h
                  })
                }, "print" == g && (ta = e[g]), "printErr" == g && (x = e[g]);
              z = c.kc;
              E();
              Ha(c.lc)
            } else if ("run" === d) {
            ...
            } else "setimmediate" !== c.target && ("checkMailbox" === d ? Ja && Ra() : d && (x(`worker: received unknown command ${d}`), x(c)))
          } catch (f) {
            throw Sa(), f;
          }
        }
      ...
      async function $a(a) {
        var b = Xa;
        if (!ua && "function" == typeof WebAssembly.instantiateStreaming && !qa(b) && !n) try {
          var c = fetch(b, {
            credentials: "same-origin"
          });
      ...
      var Dc = {
        ...
        833403: (a, b, c, d, f) => {
          e.jb("ReduceMax", a, {
            keepDims: !!b,
            noopWithEmptyAxes: !!c,
            axes: d ? Array.from(H().subarray(Number(d) >>>
              0, Number(f) >>> 0)) : []
          })
        },
        833577: (a, b, c, d, f) => {
        ...
        835859: (a, b, c, d, f, g, h, l, m, p, r, u, w, y) => {
          e.jb("ConvTranspose", a, {
            format: l ? "NHWC" : "NCHW",
            autoPad: b,
            dilations: Array.from(H().subarray(Number(c) >>> 0, (Number(c) >>> 0) + 2 >>>
              0)),
            group: d,
        ...
        836953: (a, b, c, d, f, g, h, l, m, p, r, u, w, y) => {
          e.jb("ConvTranspose", a, {
            ...
            group: d,
            kernelShape: Array.from(H().subarray(Number(f) >>> 0, (Number(f) >>> 0) +
              2 >>> 0)),
            pads: Array.from(H().subarray(Number(g) >>> 0, (Number(g) >>> 0) + 4 >>> 0)),
            strides: Array.from(H().subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)),
            wIsConst: () => !!D()[m >>> 0],
        ...
        839403: (a, b, c, d, f, g, h, l, m, p, r, u, w, y) => {
          e.jb("MaxPool", a, {
            ...
            count_include_pad: d,
            storage_order: f,
            dilations: g ? Array.from(H().subarray(Number(g) >>>
              0, Number(h) >>> 0)) : [],
            kernel_shape: l ? Array.from(H().subarray(Number(l) >>> 0, Number(m) >>> 0)) : [],
            pads: p ? Array.from(H().subarray(Number(p) >>> 0, Number(r) >>> 0)) : [],
            strides: u ? Array.from(H().subarray(Number(u) >>> 0, Number(w) >>> 0)) : []
        ...
        840814: (a, b, c, d, f, g, h, l, m, p, r) => {
          e.jb("Resize", a, {
            antialias: b,
            axes: c ? Array.from(H().subarray(Number(c) >>>
              0, Number(d) >>> 0)) : [],
        ...
        843391: (a, b, c, d, f, g, h, l, m, p, r, u, w, y, ba, Vd) => {
          e.jb("Conv", a, {
            ...
            group: f,
            kernel_shape: g ? Array.from(H().subarray(Number(g) >>>
              0, Number(h) >>> 0)) : [],
      ...
      var Gc = a => {
        ...
        Q = (a, b, ...c) => {
          for (var d = 2 * c.length, f = Mc(), g = Nc(8 * d), h = g >>> 3, l = 0; l < c.length; l++) {
            var m = c[l];
            "bigint" == typeof m ? (C[h + 2 * l] = 1n, C[h + 2 * l + 1] = m) : (C[h + 2 * l] = 0n, J()[h + 2 * l + 1 >>> 0] = m)
          }
          a = Oc(a, 0, d, g, b);
          Pc(f);
          return a
      ...
      var Jc = a => new Promise(b => {
        a.onmessage = g => {
          g = g.data;
          var h = g.Bb;
          if (g.Gb && g.Gb != Ka()) {
            var l = O[g.Gb];
            l ? l.postMessage(g, g.Mb) : x(`Internal error! Worker sent a message "${h}" to target pthread ${g.Gb}, but that thread no longer exists!`)
      ...
      var cd = "undefined" != typeof TextDecoder ? new TextDecoder : void 0,
        dd = (a, b = 0, c = NaN) => {
          ...
          var d = b + c;
          for (c = b; a[c] && !(c >= d);) ++c;
          if (16 < c - b && a.buffer && cd) return cd.decode(a.buffer instanceof ArrayBuffer ? a.subarray(b, c) : a.slice(b, c));
          for (d = ""; b < c;) {
            var f = a[b++];
            if (f & 128) {
              var g = a[b++] & 63;
              if (192 == (f & 224)) d += String.fromCharCode((f & 31) << 6 | g);
                ...
                65536 > f ? d += String.fromCharCode(f) : (f -= 65536, d += String.fromCharCode(55296 | f >> 10, 56320 |
                  f & 1023))
              }
      ...
      function ub(a, b, c) {
        ...
        T(a, {
          ...
          toWireType: function(d, f) {
            if ("bigint" != typeof f && "number" != typeof f) throw null === f ? f = "null" : (d = typeof f, f = "object" === d || "array" === d || "function" === d ? f.toString() : "" + f), new TypeError(`Cannot convert "${f}" to ${this.name}`);
      ...
      function yb(a, b, c, d, f) {
        a >>>= 0;
        c >>>= 0;
        b = R(b >>> 0); - 1 === f && (f = 4294967295);
        f = l => l;
        if (0 === d) {
          var g = 32 - 8 * c;
          f = l => l << g >>> g
        }
        var h = b.includes("unsigned") ? function(l, m) {
          return m >>> 0
        } : function(l, m) {
          return m
        };
        ...
        T(a, {
          ...
          fromWireType: function(c) {
            for (var d = I()[c >>> 2 >>> 0], f = c + 4, g, h = f, l = 0; l <= d; ++l) {
              var m = f + l;
              if (l == d || 0 == F()[m >>> 0]) h = M(h, m - h), void 0 === g ? g = h : (g += String.fromCharCode(0), g += h), h = m + 1
            }
            Y(c);
            return g
          },
          toWireType: function(c, d) {
            ...
            if (!(f || d instanceof Uint8Array || d instanceof Uint8ClampedArray || d instanceof Int8Array)) throw new S("Cannot pass non-string to std::string");
        ...
        T(a, {
          ...
          fromWireType: l => {
            for (var m = I()[l >>> 2 >>> 0], p, r = l + 4, u = 0; u <= m; ++u) {
              var w = l + 4 + u * b;
              if (u == m || 0 == h(w)) r = d(r, w - r), void 0 === p ? p = r : (p += String.fromCharCode(0), p += r), r = w + b
            }
            Y(l);
            return p
          },
      ...
      function Oa(a) {
        a >>>= 0;
        "function" === typeof Atomics.jc && (Atomics.jc(H(), a >>> 2, a).value.then(Ra), a += 128, Atomics.store(H(), a >>> 2, 1))
      }
      var Ra = () => {
        var a = Ka();
        a && (Oa(a), zd(Ad))
      ...
      function Eb(a, b) {
        a >>>= 0;
        a == b >>> 0 ? setTimeout(Ra) : q ? postMessage({
          Gb: a,
          Bb: "checkMailbox"
        }) : (a = O[a]) && a.postMessage({
          Bb: "checkMailbox"
      ...
      function Hd() {
        var a = K,
          b = {};
        for (let [c, d] of Object.entries(a)) b[c] = "function" == typeof d ? (...f) => {
          Id.push(c);
          try {
            return d(...f)
          } finally {
            A || (Id.pop(), t && 1 === Z && 0 === Id.length && (Z = 0, P += 1, Gd(Jd), "undefined" != typeof Fibers && Fibers.rc()))
          }
        } : d;
        return b
      }
      ...
      var ae = a => {
        ...
        ce = (a, b) => Object.defineProperty(b, "name", {
          value: a
        });
      ...
      function Qb(a, b, c) {
        ...
        var f = "return function (obj, func, destructorsRef, args) {\n",
          ...
          h = [];
        0 === c && h.push("obj");
        for (var l = ["retType"], m = [d], p = 0; p < a; ++p) h.push("arg" + p), l.push("argType" + p), m.push(b[p]), f += `  var arg${p} = argType${p}.readValueFromPointer(args${g?"+"+g:""});\n`, g += b[p].Cb;
      ...
      function cc(a) {
        a >>>= 0;
        var b = new Date(H()[a + 20 >>> 2 >>> 0] + 1900, H()[a + 16 >>> 2 >>> 0], H()[a + 12 >>> 2 >>> 0], H()[a + 8 >>> 2 >>> 0], H()[a + 4 >>> 2 >>> 0], H()[a >>> 2 >>> 0], 0),
          c = H()[a + 32 >>> 2 >>> 0],
          d = b.getTimezoneOffset(),
          f = (new Date(b.getFullYear(), 6, 1)).getTimezoneOffset(),
          g = (new Date(b.getFullYear(), 0, 1)).getTimezoneOffset(),
          h = Math.min(g, f);
        0 > c ? H()[a + 32 >>> 2 >>> 0] = Number(f != g && h == d) : 0 < c != (h == d) && (f = Math.max(g, f), b.setTime(b.getTime() + 6E4 * ((0 < c ? h : f) - d)));
        H()[a + 24 >>> 2 >>> 0] = b.getDay();
        c = (ee(b.getFullYear()) ? fe : ge)[b.getMonth()] +
          b.getDate() - 1 | 0;
        H()[a + 28 >>> 2 >>> 0] = c;
      ...
      var ke = [],
        le = (a, b) => {
          ...
          for (var c; c = F()[a++ >>> 0];) {
            ...
            d &= 112 != c;
            b += d && b % 8 ? 4 : 0;
            ke.push(112 == c ? I()[b >>> 2 >>> 0] : 106 == c ? C[b >>> 3] : 105 == c ? H()[b >>> 2 >>> 0] : J()[b >>> 3 >>> 0]);
            b += d ? 8 : 4
          }
          return ke
        };
      ...
      (async function() {
        ...
        Ua++;
        var b = ab();
        if (e.instantiateWasm) return new Promise(d => {
          e.instantiateWasm(b, (f, g) => {
            a(f, g);
            d(f.exports)
          })
        });
        if (q) return new Promise(d => {
          Ha = f => {
            var g = new WebAssembly.Instance(f, ab());
            d(a(g, f))
          }
        });
        Xa ??= e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", v) : v + "ort-wasm-simd-threaded.jsep.wasm" : (new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url)).href;
        try {
          var c = await $a(b);
      ...
      e._OrtCreateSessionOptions = (a, b, c, d, f, g, h, l, m, p) => (e._OrtCreateSessionOptions = K.Ha)(a, b, c, d, f, g, h, l, m, p);
